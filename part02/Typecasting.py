...
# Notice the function always rounds down, and not according to the rounding rules in mathematics.
# This is an example of a floor function.
# Sample output
# Please type in a temperature: 8.99
# The temperature is 8.99
# ...and rounded down it is 8
# Please write a program which asks the user for a floating point number and then prints out the integer
# part and the decimal part separately. Use the Python int function.
...
int_part=int(number)
dec_part=round(number-int_part,2)
