...
#
# The factorial of a number involves multiplying the number by all the positive
# integers smaller than itself. In other words, it is the product of all positive
# integers less than or equal to the number. For example, the factorial of 5 is 1 * 2 * 3 * 4 * 5 = 120.
#
